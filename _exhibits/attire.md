...
{% raw %} {% include inline_image.html collection='unstable_archives' pid='item6' %} {% endraw %} 
...
{% raw %} {% include inline_image.html collection='unstable_archives' pid='item2' %} {% endraw %} 
